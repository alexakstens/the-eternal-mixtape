...
The interaction flows in this order:
    ...
    2) the application parses the song using offline audio analysis
    3) the user is presented with a low-complexity user interface that allows them to rearrange the song as they please

This application is inspired by both the [Eternal Jukebox](https://eternalboxmirror.xyz/jukebox_index.html) and [Mixboard](https://www.nime.org/proceedings/2023/nime2023_69.pdf).

The former offers a simplistic user interface with very little interaction, splicing up songs based on audio similarity. 
Our application will extend on this core concept while offering the user more agency to rearrange the song in their own way.
